- [**CommonModule**](https://angular.io/docs/ts/latest/api/common/index/CommonModule-class.html): the module that includes all the basic Angular directives like `NgIf`, `NgFor`, ...
